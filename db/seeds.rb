...
is_artist: true, genre_id: 7, artistName: "Bluey Vluey", location: "San Francisco, California")
...
album3 = Album.create(title: "Straight No Chaser", artist_id: 3, downloadable: true, genre_id: 2)
album4 = Album.create(title: "Tomorrow is a Long Time", artist_id: 4, downloadable: true, genre_id: 6)
album5 = Album.create(title: "Freewheeling", artist_id: 4, downloadable: true, genre_id: 6)
...
track7 = Track.create(title: "Cookies and Milk", artist_id: 3, downloadable: true, genre_id: 2, album_id: 2, track_number: 1 )
track8 = Track.create(title: "It's Cool", artist_id: 3, downloadable: true, genre_id: 2, album_id: 2, track_number: 2 )
track9 = Track.create(title: "Time to Fly", artist_id: 3, downloadable: true, genre_id: 2, album_id: 2, track_number: 3 )
...
track17 = Track.create(title: "Freewheeling", artist_id: 4, downloadable: true, genre_id: 6, album_id: 5, track_number: 1 )
track18 = Track.create(title: "It's Not", artist_id: 4, downloadable: true, genre_id: 6, album_id: 5, track_number: 2 )
track19 = Track.create(title: "Tantalizing", artist_id: 4, downloadable: true, genre_id: 6, album_id: 5, track_number: 3)
...
track29 = Track.create(title: "Yeah, I Know", artist_id: 6, downloadable: true, genre_id: 7, track_number: 1)
