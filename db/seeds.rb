...
ActiveRecord::Base.transaction do
     ...
     track24.song_file.attach(io:track_file17, filename:"mine3")
     track25.song_file.attach(io:track_file12, filename:"mine4")
     track26.song_file.attach(io:track_file18, filename:"mine5")
     track27.song_file.attach(io:track_file15, filename:"mine6")
     track28.song_file.attach(io:track_file16, filename:"mine7")
